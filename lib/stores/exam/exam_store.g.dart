...
mixin _$ExamStore on _ExamStore, Store {
  ...
  @override
  Future startExam(String examId, String studentId, String token, int duration,
      BuildContext context) {
    return _$startExamAsyncAction.run(
        () => super.startExam(examId, studentId, token, duration, context));
  }
